...
acc_data|>
  ...
  labs(
   ...
   theme(axis.text.x = element_text(angle = 30,vjust = 0.85,hjust = 0.75))
```
The median age increases with higher education levels for both males and females. Males generally have a wider distribution of ages compared to females in each education category. 
This plot suggests that individuals with lower education levels tend to be older. This might reflect patterns related to generational differences, where older individuals might have had less access to higher education. Additionally, the greater age variability in males might indicate a broader range of educational attainment across different ages in the male population compared to females.
...
As shown in the reader-friendly table, it has 4 rows and 4 variables, including number of member,number of casual, year and month. The total numbers of casual riders riding in Jan. 2020, July 2020, Jan. 2024, July 2024 are respectively 984, 5637, 2108, 10894. The total numbers of Citi Bike members riding in Jan. 2020, July 2020, Jan. 2024, July 2024 are respectively 11436, 15411, 16753, 36262. In general, the number of casual riders is less than Citi Bike members.
